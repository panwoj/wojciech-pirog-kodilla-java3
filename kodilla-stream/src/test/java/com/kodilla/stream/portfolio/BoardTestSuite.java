...
public class BoardTestSuite {
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        List<TaskList> inProgressTasks = new ArrayList<>();
        inProgressTasks.add(new TaskList("In progress"));
        long sumOfLongTasksCreatedDates = project.getTaskLists().stream()
                .filter(inProgressTasks::contains)
        ...
        long numberOfLongTasks = project.getTaskLists().stream()
                ...
                .flatMap(t1 -> t1.getTasks().stream())
                .count();
        long averageDaysOfLongTasks = sumOfLongTasksCreatedDates/numberOfLongTasks;

        //Then
        Assert.assertEquals(10, averageDaysOfLongTasks);
