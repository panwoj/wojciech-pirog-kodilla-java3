...
public class TaxiOrderTestSuite {
    ...
    public void testBasicTaxiOrderGetCost() {
        ...
        //When
        BigDecimal caluclatedCost = theOrder.getCost();
        //Then
        assertEquals(new BigDecimal(5), caluclatedCost);
    }
    ...
    public void testUberWithTwoChildSeatGetDescription() {
        ...
        String description = theOrder.getDescription();
        //Then
        assertEquals("Drive a course by Uber Network + child seat + child seat",
                description);
    }

    @Test
    public void testVipTaxiWithTwoChildSeatExpressGetCost() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();
        theOrder = new TaxiNetworkOrderDecorator(theOrder);
    ...
    @Test
    public void testVipTaxiWithTwoChildSeatExpressGetDescription() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();
        theOrder = new TaxiNetworkOrderDecorator(theOrder);
        theOrder = new VipCarDecorator(theOrder);
